              ...
              if (points.length > 0) {
                  ...
                  array_ofMarkers = capa_actual.features.filter((feature) => {
                    if(level=="Pasajeros" & label=="Muertos"){
                      return (feature.properties.TOT_MUERT-feature.properties.CONDMUE>0)
                    }else if(level=="Pasajeros" & label=="Heridos"){
                      return (feature.properties.TOT_HER-feature.properties.CONDHER>0)
...
promesa_primeros_afectados.then(({muertos, heridos, cond_muertos, cond_heridos}) => {
